...
export default function WorkExperience({}: Props) {
  return (
    ...
    >
      ...
      <div
        className={
          "w-full flex space-x-5 overflow-x-scroll p-10 snap-x snap-mandatory scrollbar scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[rgb(var(--primary))]"
        }
      >
        <ExperienceCard />
        <ExperienceCard />
